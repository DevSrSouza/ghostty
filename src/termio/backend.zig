...
pub const Kind = enum { exec, passive };
...
pub const Config = union(Kind) {
    ...
    /// Passive has no pty; the host feeds bytes in via Termio.processOutput.
    passive: termio.Passive.Config,
};
...
pub const Backend = union(Kind) {
    exec: termio.Exec,
    passive: termio.Passive,

    pub fn deinit(self: *Backend) void {
        switch (self.*) {
            .exec => |*exec| exec.deinit(),
            .passive => |*passive| passive.deinit(),
        }
    }
    ...
    pub fn initTerminal(self: *Backend, t: *terminal.Terminal) void {
        switch (self.*) {
            ...
            .passive => |*passive| passive.initTerminal(t),
        }
    }
    ...
    pub fn threadEnter(
        ...
        switch (self.*) {
            ...
            .passive => |*passive| try passive.threadEnter(alloc, io, td),
        }
    }
    ...
    pub fn threadExit(self: *Backend, td: *termio.Termio.ThreadData) void {
        switch (self.*) {
            ...
            .passive => |*passive| passive.threadExit(td),
        }
    }
    ...
    pub fn focusGained(
        ...
        switch (self.*) {
            ...
            .passive => |*passive| try passive.focusGained(td, focused),
        }
    }
    ...
    pub fn resize(
        ...
        switch (self.*) {
            ...
            .passive => |*passive| try passive.resize(grid_size, screen_size),
        }
    }
    ...
    pub fn queueWrite(
        ...
        switch (self.*) {
            ...
            .passive => |*passive| try passive.queueWrite(alloc, td, data, linefeed),
        }
    }
    ...
    pub fn childExitedAbnormally(
        ...
        switch (self.*) {
            ...
            .passive => |*passive| try passive.childExitedAbnormally(
                gpa,
                t,
                exit_code,
                runtime_ms,
...
pub const ThreadData = union(Kind) {
    ...
    passive: termio.Passive.ThreadData,

    pub fn deinit(self: *ThreadData, alloc: Allocator) void {
        switch (self.*) {
            .exec => |*exec| exec.deinit(alloc),
            .passive => |*passive| passive.deinit(alloc),
        }
    }
